...
class TimingEvent(object):
    """A Cosmic Laser Show Timing Event"""
    ...
    def __init__(self, msg):
        ...
        threshold = 50.
        self.t1 = next((index for index, value in enumerate(self.trace_ch1) if (value > threshold)), None)
        self.t2 = next((index for index, value in enumerate(self.trace_ch2) if (value > threshold)), None)
