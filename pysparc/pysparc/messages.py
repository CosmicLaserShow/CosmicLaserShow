...
class MeasuredDataMessage(HisparcMessage):
    ...
    def __str__(self):
        ...
        threshold = 50.
        t1 = next((index for index, value in enumerate(self.trace_ch1) if (value > threshold)), None)
        t2 = next((index for index, value in enumerate(self.trace_ch2) if (value > threshold)), None)
        #plt.plot(self.trace_ch2)
        #plt.plot(self.trace_ch1)
        #plt.show()
        return 'Event message: {} {} {}'.format(self.datetime, t1, t2)
...
class SetControlParameter(HisparcMessage):
    ...
    def __str__(self):
        return "Set control parameter {} to {}".format(self.parameter, self.data)
